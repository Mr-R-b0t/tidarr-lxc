...
INSTALL_SCRIPT_URL="https://raw.githubusercontent.com/Mr-R-b0t/tidarr-lxc/main/install/maintainerr-install.sh"
...
header_info() {
  ...
  cat <<"EOF"
  __  __       _       _        _                     
 |  \/  | __ _(_)_ __ | |_ __ _(_)_ __   ___ _ __ _ __ 
 | |\/| |/ _` | | '_ \| __/ _` | | '_ \ / _ \ '__| '__|
 | |  | | (_| | | | | | || (_| | | | | |  __/ |  | |   
 |_|  |_|\__,_|_|_| |_|\__\__,_|_|_| |_|\___|_|  |_|   

EOF
  echo -e "${YW}Maintainerr LXC Container Creator${CL}\n"
}
...
echo -e "  ${GN}http://${CONTAINER_IP}:6246${CL}"
echo ""
echo -e "${YW}Useful commands:${CL}"
echo -e "  pct exec $CTID -- docker ps"
echo -e "  pct exec $CTID -- bash -c 'cd /opt/maintainerr && docker compose logs -f'"
